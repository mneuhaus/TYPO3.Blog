...
class Setup extends F3::FLOW3::MVC::Controller::ActionController {
	...
	public function defaultAction() {
		...
		$tag2->setName('PHP');
		$tag3 = $this->componentFactory->getComponent('F3::Blog::Domain::Tag');
		$tag3->setName('Java');
		...
		$post1 = $this->componentFactory->getComponent('F3::Blog::Domain::Post');
		...
		$post2 = $this->componentFactory->getComponent('F3::Blog::Domain::Post');
		...
		$post3 = $this->componentFactory->getComponent('F3::Blog::Domain::Post');
		...
		$blog = $this->componentFactory->getComponent('F3::Blog::Domain::Blog', 'FLOW3');
		$blog->addPost($post1);
		$blog->addPost($post2);
		$blog->addPost($post3);
